...
<channel>
	...
	<atom:link href="http://localhost/iukones/template/category/blog/feed/" rel="self" type="application/rss+xml" />
	<link>http://localhost/iukones/template</link>
	<description></description>
	<lastBuildDate>Fri, 13 Oct 2017 22:57:58 +0000</lastBuildDate>
...
<image>
	...
	<item>
		...
		<description><![CDATA[<p>Esta es una página de ejemplo, Es diferente a una entrada de un blog porque se mantiene estática y se mostrará en la barra de navegación (en la mayoría de temas). Casi todo el mundo comienza con una página &#8220;Acerca De&#8221; para presentarse a los </p>
...
<p>Si eres nuevo en WordPress deberías ir a <a href="http://localhost/iukones/template/wp-admin/">tu escritorio</a> para borrar esta página y crear algunas nuevas con tu contenido. ¡Diviértete!</p>
<p>The post <a rel="nofollow" href="http://localhost/iukones/template/2017/10/12/como-integrar-wordpress-con-github-pages/">Como integrar WordPress con Github Pages.</a> appeared first on <a rel="nofollow" href="http://localhost/iukones/template">Israel Martínez | Front-end Developer</a>.</p>
]]></content:encoded>
