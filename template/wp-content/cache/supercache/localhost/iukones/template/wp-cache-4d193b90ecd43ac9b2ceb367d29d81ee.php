...
<meta property="og:title" content="Inicio - Israel Martínez | Front-end Developer" />
<meta property="og:description" content="Bienvenido al sitio de Israel Martínez (iukones) .
Hola, soy Israel. Un desarrollador de web front-end freelance radicado en la ciudad de México, trabajando con compañías de todo el mundo. Me asocio con equipos de diseño para ejecutar y construir interfaces de usuario y sistemas de diseño web hermosos y progresivos," />
<meta property="og:url" content="http://localhost/iukones/template/" />
<meta property="og:site_name" content="Israel Martínez | Front-end Developer" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:description" content="Bienvenido al sitio de Israel Martínez (iukones) .
Hola, soy Israel. Un desarrollador de web front-end freelance radicado en la ciudad de México, trabajando con compañías de todo el mundo. Me asocio con equipos de diseño para ejecutar y construir interfaces de usuario y sistemas de diseño web hermosos y progresivos, " />
<meta name="twitter:title" content="Inicio - Israel Martínez | Front-end Developer" />
...
<script type='application/ld+json'>{"@context":"http:\/\/schema.org","@type":"Person","url":"http:\/\/localhost\/iukones\/template\/","sameAs":[],"@id":"#person","name":"Israel Martinez Villanueva"}</script>
<!-- / Yoast SEO plugin. -->
		...
		<div class="header_in">
			...
			<nav>
				<div id="cssmenu">
					...
					<ul><li id="menu-item-18" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-18"><a href="http://localhost/iukones/template/">Inicio</a></li>
...
<div class="banner ">
	...
	<a href="http://localhost/iukones/template/"></a>
	<div class="block_cont_in">
		...
		<div class="clear"></div>
        <div class="content">
		<h2 class="mt0"><span class="">Bienvenido al</span> sitio <u>de</u> Israel Martínez (iukones) .</h2>
...
<span class="edit-link"><a class="post-edit-link" href="http://localhost/iukones/template/wp-admin/post.php?post=7&#038;action=edit">Edit</a></span>        </div>
	...
	<div id="comments" class="comments-area">
		<p class="no-comments">Comments are closed.</p>
			...
			<div class="nav-links">
				<div class="nav-next"><a href="http://localhost/iukones/template/sobre-mi/" rel="next">Sobre mi.</a></div>			</div>
			<!-- .nav-links -->
		</nav><!-- .navigation -->
	</div>		</div>
...
<script type='text/javascript' src='http://localhost/iukones/template/wp-includes/js/wp-embed.min.js?ver=4.8.2'></script>
	...
	<!--<![endif]-->
		...
		<li id="wp-admin-bar-wpseo-kwdensity"><a class="ab-item" href="http://www.zippy.co.uk/keyworddensity/index.php?url=http%3A%2F%2Flocalhost%2Fiukones%2Ftemplate%2F&#038;keyword=wordpress+con+github+pages" target="_blank">Comprobar la densidad de palabras clave</a>		</li>
...
<!-- Cached page generated by WP-Super-Cache on 2017-10-18 18:05:04 -->
